...
#define buzzer_pin 2
Servo myservo;
int Micpin  =  A2, Micvalue = 0;
bool IsRoar = false;
unsigned long long Time_millis = millis();
unsigned long long OLEDShowTime = millis();
int timeHH, timeMM, timeSS, year, month, day;
